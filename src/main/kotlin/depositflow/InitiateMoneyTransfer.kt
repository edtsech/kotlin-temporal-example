...
object InitiateMoneyTransfer {
    ...
    fun main(args: Array<String>) {
        ...
        val options = WorkflowOptions.newBuilder()
            .setTaskQueue(MONEY_TRANSFER_TASK_QUEUE) // A WorkflowId prevents this it from having duplicate instances, remove it to duplicate.
        ...
        val workflow: IMoneyTransferWorkflow = client.newWorkflowStub(IMoneyTransferWorkflow::class.java, options)
